...
| Network interface for discovery | `udpBindAddress` | `interface` |  | IP address of the interface the UDP discovery socket binds to. Empty means all interfaces, which can fail on hosts with several networks.<br>Hidden when `!data.udpDiscoveryEnabled` |
...
| --- | --- | --- | --- | --- |
| Roborock S6 Pure (a08) | `roborock.vacuum.a08` | V1 | 21 | 2 |
| Roborock S6 MaxV (a10) | `roborock.vacuum.a10` | V1 | 21 | 6 |
| Roborock Q Revo Pro (a101) | `roborock.vacuum.a101` | V1 | 27 | 19 |
| Roborock Qrevo S (a104) | `roborock.vacuum.a104` | V1 | 21 | 14 |
| Roborock Qrevo Master (a117) | `roborock.vacuum.a117` | V1 | 26 | 22 |
| Roborock Qrevo Curv (a135) | `roborock.vacuum.a135` | V1 | 26 | 29 |
| Roborock Saros 10R (a144) | `roborock.vacuum.a144` | V1 | 26 | 23 |
| Roborock Saros 10 (a147) | `roborock.vacuum.a147` | V1 | 26 | 28 |
| Roborock S7 (a15) | `roborock.vacuum.a15` | V1 | 21 | 7 |
| Roborock Qrevo Edge (a156) | `roborock.vacuum.a156` | V1 | 26 | 22 |
| Roborock Qrevo Curv Series (a159) | `roborock.vacuum.a159` | V1 | 26 | 22 |
| Roborock Qrevo L (a168) | `roborock.vacuum.a168` | V1 | 26 | 22 |
| Roborock Saros Z70 (a179) | `roborock.vacuum.a179` | V1 | 167 | 28 |
| Roborock Qrevo Edge Series (a187) | `roborock.vacuum.a187` | V1 | 26 | 22 |
| Roborock S4 Max (a19) | `roborock.vacuum.a19` | V1 | 21 | 1 |
| Roborock Qrevo Slim (a21) | `roborock.vacuum.a21` | V1 | 26 | 22 |
| Roborock S7 MaxV (Pro/Ultra) (a27) | `roborock.vacuum.a27` | V1 | 26 | 24 |
| Roborock Saros 20 (a288) | `roborock.vacuum.a288` | V1 | 26 | 28 |
| Roborock Qrevo Edge 2 (a298) | `roborock.vacuum.a298` | V1 | 26 | 22 |
| Roborock Q7 Max (a38) | `roborock.vacuum.a38` | V1 | 21 | 7 |
| Roborock Q7 (a40) | `roborock.vacuum.a40` | V1 | 21 | 5 |
| Roborock S8 (a51) | `roborock.vacuum.a51` | V1 | 21 | 14 |
| Roborock S7 Pro Ultra (a62) | `roborock.vacuum.a62` | V1 | 21 | 10 |
| Roborock S7 Max Ultra (a65) | `roborock.vacuum.a65` | V1 | 21 | 13 |
| Roborock S8 Pro Ultra (a70) | `roborock.vacuum.a70` | V1 | 26 | 20 |
| Roborock Q5 Pro (a72) | `roborock.vacuum.a72` | V1 | 21 | 14 |
| Roborock Q8 Max (a73) | `roborock.vacuum.a73` | V1 | 21 | 14 |
| Roborock Q Revo (a75) | `roborock.vacuum.a75` | V1 | 21 | 17 |
| Roborock Qrevo MaxV (a87) | `roborock.vacuum.a87` | V1 | 22 | 23 |
| Roborock S8 MaxV Ultra (a97) | `roborock.vacuum.a97` | V1 | 26 | 28 |
| Roborock S4 | `roborock.vacuum.s4` | V1 | 21 | 0 |
| Roborock S5 Max | `roborock.vacuum.s5e` | V1 | 21 | 3 |
| Roborock S6 | `roborock.vacuum.s6` | V1 | 21 | 3 |
