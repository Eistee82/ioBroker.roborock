...
import { ZONE_HANDLE_GLYPHS, ZONE_HANDLE_KINDS, type ZoneHandleKind } from "./zoneHandles";
...
describe("the pinned glyph paths", () => {
	it.each(ZONE_HANDLE_KINDS)("matches the MUI icon the %s handle is taken from", (kind) => {
	...
	it.each(ZONE_HANDLE_KINDS)("is drawn in the 24 × 24 box the handles place it in (%s)", (kind) => {
